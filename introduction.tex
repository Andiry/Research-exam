...
memristor-based memories~\cite{moneta, monetad, quicksan,Onyx,pollisbetterthaninterrupt}
...
main memory (NVMM)-based systems~\cite{PCM_EfficientMainMemory, PCM_Hierarchy,eNVy,WSP}. The close coupling of compute and
...
file systems for NVMMs~\andiry{\cite{PMFS,BPFS}}, non-volatile
