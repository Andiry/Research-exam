...
and Section~\ref{sec:overall} shows the different approaches to utilize
the NVMM in the system.
Section~\ref{sec:filesystem} discusses the NVMM file system design principles and
challenges.
In Section~\ref{sec:caching} we show the systems that use NVMM as a cache
to accelerate storage access, and
Section~\ref{sec:access-model} shows the accessing models to access NVMM
efficiently.
Section~\ref{sec:migrate} introduces the design of systems with both DRAM and NVMM
