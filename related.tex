...
\subsection{System design impact} 
\label{sec:systemdesign}

Some researches give a overview of NVMM system and proposes software
design suggestions.
...
We've introduced the major software works to design the NVMM system. Most
of them rely on some hardware primitives assistance, such as BPFS and PMFS.
...
eliminated, and find out that the memory copy latency accounts for 76\% for read
and 77\% for write.
