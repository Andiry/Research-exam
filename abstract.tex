...
to access NVMM to exploit the performance.
...
We divide the approaches into four major categories: DRAM extension,
file system, programming model and caching and acceleration. We
