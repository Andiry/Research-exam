...
the NVMM software researches on four categories: file system, accessing model,
hybrid system design and caching and acceleration. With NVMM sitting on the
processor memory bus, it does not only allow applications to access directly
to reduce overhead, but also bring design issues such as CPU caching impact
